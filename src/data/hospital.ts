...
export const rooms: Room[] = [
  ...
  { id: "imaging_center", name: "영상의학센터", floor: 1, position: { x: 1.25, y: 0, z: 2.35 }, size: [1.65, 0.35, 1.2], queue: 18, examMinutes: 14, examId: "imaging", type: "exam" },
  ...
  { id: "blood_room", name: "채혈실", floor: 2, position: { x: -2.55, y: FLOOR_HEIGHT, z: -1.05 }, size: [0.85, 0.35, 0.6], queue: 42, examMinutes: 6, examId: "blood", type: "exam" },
  { id: "cardiac_test", name: "외래심장검사실", floor: 2, position: { x: -1.4, y: FLOOR_HEIGHT, z: -1.45 }, size: [0.95, 0.35, 0.6], queue: 11, examMinutes: 9, examId: "ecg", type: "exam" },
  { id: "respiratory_test", name: "호흡기검사실", floor: 2, position: { x: -1.0, y: FLOOR_HEIGHT, z: -2.25 }, size: [0.95, 0.35, 0.6], queue: 14, examMinutes: 8, examId: "respiratory", type: "exam" },
  { id: "injection_room", name: "주사센터", floor: 2, position: { x: 0.75, y: FLOOR_HEIGHT, z: -3.05 }, size: [1.1, 0.35, 0.6], queue: 17, examMinutes: 12, examId: "injection", type: "exam" },
  ...
  { id: "endoscopy_center", name: "소화기내시경센터", floor: 2, position: { x: 1.15, y: FLOOR_HEIGHT, z: 2.25 }, size: [1.35, 0.35, 0.75], queue: 29, examMinutes: 18, examId: "endoscopy", type: "exam" },
